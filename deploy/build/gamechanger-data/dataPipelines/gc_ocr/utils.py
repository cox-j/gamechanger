...
class PDFOCR:
    ...
    def convert(self, raise_error: bool = False) -> bool:
        ...
        exit_code = ocrmypdf.ocr(
            ...
            skip_text=True if self.job_type == OCRJobType.SKIP_TEXT else False,
            redo_ocr=True if self.job_type == OCRJobType.REDO_OCR else False,
            force_ocr=True if self.job_type == OCRJobType.FORCE_OCR else False,

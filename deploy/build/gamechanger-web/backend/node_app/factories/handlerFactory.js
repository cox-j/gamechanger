...
class HandlerFactory {
	...
	reloadCloneMeta() {
		...
		CLONE_META.findAll().then((meta) => {
			...
			meta.forEach((m) => {
				// this.logger.info(JSON.stringify(m))
				// this.logger.info("row32 - handlerFactory.js")
			...
			// this.logger.info("row46 - handlerFactory.js")
			// this.logger.info(JSON.stringify(CLONE_META))

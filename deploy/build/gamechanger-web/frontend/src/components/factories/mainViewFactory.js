...
const asrsMainViewHandler = require(`../modules/asrs/asrsMainViewHandler`);
const imMainViewHandler = require(`../modules/im/imMainViewHandler`);
		...
		try {
			switch (module) {
				...
				case 'eda/edaMainViewHandler':
					...
					break;
				case 'asrs/asrsMainViewHandler':
					this.handler = asrsMainViewHandler;
					break;
				case 'im/imMainViewHandler':
					this.handler = imMainViewHandler;
					break;

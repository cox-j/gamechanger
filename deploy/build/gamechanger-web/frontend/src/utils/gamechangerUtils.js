...
export const orgColorMap = { //CHANGE THIS FOR ASRS
...
const linkColorMap = { //CHANGE THIS FOR ASRS
	belongs_to: '#B8860B', // mustard yellow
	references: '#808080', // gray
};

// export const typeColorMap = { //CHANGE THIS FOR ASRS
// 	document: '#386F94',
// 	organization: '#386f94',
// 	topic: '#ffbf00',
// 	uknDocument: '#000000',
...
export const typeColorMap = { //CHANGE THIS FOR ASRS
	...
	PLACE: 'purple',
	TEXT_TOPIC: 'gold',
	SUMMARY_TOPIC: '#204b53', //turquoise
	COMPONENT: 'brown',
	KEYWORD: '#204b53' //turquoise
};

const typeTextColorMap = { //CHANGE THIS FOR ASRS
	Document: 'black',
	Taxonomy: 'black',
	AIRCRAFT: 'black',
	ASSESSMENTS: 'black',
